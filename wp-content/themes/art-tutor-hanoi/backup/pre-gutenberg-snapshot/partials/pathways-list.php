          ...
          <?php if ( $has_courses ) : ?>
            <ul class="pathway__courses<?php echo $use_detail ? ' pathway__courses--after-detail' : ''; ?>">
              <?php foreach ( $pathway['courses'] as $course ) : ?>
                ...
                } elseif ( ! empty( $course['experience_slug'] ) ) {
                  $course_url = ath_experience_url( $course['experience_slug'] );
                } elseif ( ! empty( $course['book_tab'] ) ) {
                  $course_url = ath_book_url( $course['book_tab'] );
                } else {
                  $course_url = isset( $course['url'] ) ? ath_resolve_url( $course['url'] ) : '#';
                }
                ?>
                <li>
