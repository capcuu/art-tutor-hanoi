...
/**
 * Randomize home gallery images and collage layout on each page load.
 *
 * @param array $items         Rows from data/frontpage-gallery.php.
 * @param int   $visible_count Images shown before "Load more".
 * @return array<int, array<int, array>>
 */
function ath_prepare_frontpage_gallery_batches( array $items, $visible_count = 5 ) {
	if ( empty( $items ) ) {
