...
<main class="about-page">
  ...
  <section class="about-section about-team" aria-labelledby="about-team-heading">
    <div class="about-section__inner">
      ...
      <p class="about-team__faq">More information can be found on our <a href="https://arttutorhanoi.com/faq/">FAQ</a> page.</p>
    </div>
  </section>
    ...
    <div class="about-section__inner about-split">
      ...
      <div class="about-split__content">
        ...
        <div class="about-prose">
          <p>At <a href="https://arttutorhanoi.com/">Art Tutor Hanoi</a>, we are a team of academically trained artists — including watercolor artists, oil painters, and experienced academic drawing teachers — committed to sharing our passion in an open, international environment.</p>
