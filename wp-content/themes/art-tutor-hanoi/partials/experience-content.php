...
<main class="experience-page">
  <nav class="course-breadcrumb" aria-label="Breadcrumb">
    <ol class="course-breadcrumb__list">
      <li><a href="<?php echo esc_url( ath_page_url( 'pricing' ) ); ?>">Programs</a></li>
    ...
    <header class="experience-hero">
      ...
      <div class="experience-hero__content">
        ...
        <?php if ( ! empty( $experience['book'] ) ) : ?>
          <a href="<?php echo esc_url( ath_resolve_url( $experience['book']['url'] ) ); ?>" class="experience-hero__btn"><?php echo htmlspecialchars( $experience['book']['label'], ENT_QUOTES, 'UTF-8' ); ?></a>
        <?php endif; ?>
      </div>
    </header>
  ...
  <section class="courses-cta">
    <div class="courses-cta__inner">
      <?php if ( ! empty( $experience['book'] ) ) : ?>
        ...
        <a href="<?php echo esc_url( ath_resolve_url( $experience['book']['url'] ) ); ?>" class="courses-cta__btn"><?php echo htmlspecialchars( $experience['book']['label'], ENT_QUOTES, 'UTF-8' ); ?></a>
      <?php endif; ?>
      ...
      <p class="courses-cta__links">
        <a href="<?php echo esc_url( ath_page_url( 'pricing' ) ); ?>">All programs</a>
