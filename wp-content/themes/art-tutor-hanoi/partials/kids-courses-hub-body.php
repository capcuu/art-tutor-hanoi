<?php
/**
 * Kids courses hub body — pathways, schedule, benefits, CTA (no hero/intro).
 *
...
<section class="courses-teachers" aria-labelledby="kids-teachers-heading">
  <div class="courses-teachers__inner">
    ...
    <p><a href="<?php echo esc_url( ath_page_url( 'about-artists' ) ); ?>">Meet our artists</a></p>
  </div>
</section>
...
<?php ath_render_commercial_crosslinks( 'kids-courses' ); ?>
