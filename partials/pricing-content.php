  ...
  <section class="pricing-hero" aria-labelledby="pricing-heading">
    <div class="pricing-hero__inner">
      ...
      <p class="pricing-hero__faq">
        ...
        <a href="<?php echo htmlspecialchars( $pricing['faq_url'], ENT_QUOTES, 'UTF-8' ); ?>"><?php echo htmlspecialchars( $pricing['faq_label'], ENT_QUOTES, 'UTF-8' ); ?></a>
      </p>
    </div>
  </section>
  ...
  <section class="pricing-programs" aria-label="Program options">
    <div class="pricing-programs__inner">
      <div class="pricing-grid">
        <?php foreach ( $pricing['programs'] as $program ) : ?>
          ...
          <article class="<?php echo htmlspecialchars( $card_class, ENT_QUOTES, 'UTF-8' ); ?>" id="<?php echo htmlspecialchars( $program['id'], ENT_QUOTES, 'UTF-8' ); ?>">
            ...
            <?php endif; ?>
            <a href="<?php echo htmlspecialchars( $program['cta']['url'], ENT_QUOTES, 'UTF-8' ); ?>" class="pricing-card__btn"><?php echo htmlspecialchars( $program['cta']['label'], ENT_QUOTES, 'UTF-8' ); ?></a>
          </article>
        <?php endforeach; ?>
      </div>
      ...
      <article class="pricing-card pricing-card--residency" id="artist-residency">
        ...
        <a href="<?php echo htmlspecialchars( $residency['cta']['url'], ENT_QUOTES, 'UTF-8' ); ?>" class="pricing-card__btn"><?php echo htmlspecialchars( $residency['cta']['label'], ENT_QUOTES, 'UTF-8' ); ?></a>
      </article>
    </div>
  </section>
</main>
